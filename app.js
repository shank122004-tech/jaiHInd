...
// ██╔══██╗██╔══╝  ██║███╗██║██╔══██║██╔══██╗██║  ██║██╔══╝  ██║  ██║
// ██║  ██║███████╗╚███╔███╔╝██║  ██║██║  ██║██████╔╝███████╗██████╔╝
//  MONETIZATION SYSTEM v1.0 — CrackWithAI
// ─────────────────────────────────────────────────────────────
      ...
      <div class="native-ad-card">
        ...
        <div class="native-ad-content">
          ...
          <div class="native-ad-text">
            ...
            <div class="native-ad-desc">Premium study materials for SSC CGL 2026</div>
          </div>
...
function _doConfetti() {
  ...
  for (let i = 0; i < 60; i++) {
    setTimeout(() => {
      ...
      dot.style.cssText = `position:fixed;top:${Math.random()*30}%;left:${Math.random()*100}%;width:8px;height:8px;border-radius:${Math.random()>0.5?'50%':'2px'};background:${colors[Math.floor(Math.random()*colors.length)]};pointer-events:none;z-index:99999;animation:confettiFall 1.5s ease-out forwards;`;
...
function updateLimitUI() {
  ...
  if (state.isPremium) {
    ...
    dom.messageLimitInfo.innerHTML = `<span style="color:rgba(200,195,255,0.5);font-size:11px;">Free Plan · <a href="#" onclick="showRewardPopup();return false;" style="color:#6C63FF;text-decoration:none;">Upgrade ⭐</a></span>`;
  }
}
    ...
    if (snap.exists()) {
      ...
      try {
        ...
        if (d.isGroupAdmin) {
          ...
          localStorage.setItem('sscai_group_admin', 'true');
          if (d.groupPlan) {
            localStorage.setItem(_p + 'group_plan', d.groupPlan);
            localStorage.setItem('sscai_group_plan', d.groupPlan);
          }
        }
        if (d.battleTier) {
          localStorage.setItem('sscai_battle_tier', d.battleTier);
          const _tierMax = { battle: '10', battle_pro: '100', battle_academy: '999' };
        ...
        if (d.premiumPlan) {
          ...
          localStorage.setItem('sscai_premium_plan', d.premiumPlan);
        }
      ...
      const { updateDoc } = window._firebaseFns;
  ...
  modal.innerHTML = `
    ...
    <div style="display:flex;flex-direction:column;gap:14px;">
      ...
      <div style="background:rgba(108,99,255,0.07);border:1.5px solid rgba(108,99,255,0.40);border-radius:16px;padding:18px;position:relative;">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:6px;margin-bottom:14px;">
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>💬</span> <b>Unlimited AI questions</b></div>
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>🖼️</span> <b>10 image uploads/day</b></div>
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>🎤</span> <b>AI Teacher Voice Mode</b></div>
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>📄</span> <b>5 PDF uploads/day</b></div>
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>🤖</span> All AI models (Pro + V4)</div>
          ...
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>🇮🇳</span> SSC CGL/CHSL/GD/MTS/CPO</div>
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>🔒</span> No daily question limit</div>
        </div>
        ...
        <div style="background:rgba(108,99,255,0.12);border-radius:9px;padding:9px 12px;margin-bottom:12px;font-size:11.5px;color:rgba(220,215,255,0.80);line-height:1.5;">
          💡 <b>Why toppers choose SSC Pro:</b> Unlimited AI-powered doubt solving, image/PDF solving, Teacher Voice Mode — everything you need to crack SSC from your phone.
        </div>
      ...
      <div style="background:rgba(245,158,11,0.06);border:1.5px solid rgba(245,158,11,0.45);border-radius:16px;padding:18px;position:relative;">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:6px;margin-bottom:12px;">
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>✅</span> <b>Everything in SSC Pro</b></div>
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>✅</span> <b>Everything in Class Pro</b></div>
          ...
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>📄</span> 5 PDF uploads/day</div>
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>🤖</span> All AI models (Pro + V4)</div>
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>⚡</span> Priority AI responses</div>
        </div>
      ...
      <!-- ── Plan 3: Class Pro 9–12 ₹129/month ── -->
      <div style="background:rgba(16,185,129,0.05);border:1.5px solid rgba(16,185,129,0.30);border-radius:16px;padding:18px;position:relative;">
        <div style="position:absolute;top:-11px;left:16px;background:linear-gradient(135deg,#10b981,#6C63FF);color:#fff;font-size:10px;font-weight:800;padding:2px 11px;border-radius:20px;letter-spacing:0.05em;">🎒 STUDENTS — CLASS 9 TO 12 & COLLEGE</div>
        <div style="display:flex;align-items:center;gap:12px;margin-bottom:12px;">
          <span style="font-size:28px;">📖</span>
          <div style="flex:1;">
            <div style="font-weight:800;font-size:16px;color:#fff;">Class Pro</div>
            <div style="font-size:11px;color:rgba(200,195,255,0.55);margin-top:1px;">Class 9-12 · B.Tech · B.Sc · BCA · CBSE/NCERT</div>
          </div>
          <div style="text-align:right;">
            <div style="font-size:26px;font-weight:800;color:#34d399;line-height:1;">₹129</div>
            <div style="font-size:10px;color:rgba(200,195,255,0.45);">per month</div>
          </div>
        </div>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:6px;margin-bottom:14px;">
          ...
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>📄</span> <b>5 PDF uploads/day</b></div>
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>🤖</span> All AI models (Pro + V4)</div>
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>📚</span> Class 1-12 + B.Tech + College</div>
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>⚡</span> Priority AI responses</div>
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>🔒</span> No daily question limit</div>
        </div>
        ...
        <div style="background:rgba(16,185,129,0.10);border-radius:9px;padding:9px 12px;margin-bottom:12px;font-size:11.5px;color:rgba(167,240,210,0.80);line-height:1.5;">
          💡 <b>Board exam secret:</b> Students who get instant AI explanations for every doubt solve problems 3× faster. Class Pro gives you unlimited AI doubt solving, image solving, and Voice Teacher — all subjects, all chapters.
        </div>

        <div style="font-size:11px;color:rgba(255,200,100,0.85);font-weight:600;text-align:center;margin-bottom:10px;">🎯 Toppers clear every doubt instantly — will you?</div>
        ...
        <button onclick="handlePayment('class10')" style="width:100%;padding:13px;background:linear-gradient(135deg,#10b981,#6C63FF);border:none;border-radius:11px;color:#fff;font-size:14px;font-weight:800;cursor:pointer;box-shadow:0 4px 18px rgba(16,185,129,0.35);letter-spacing:0.02em;">
          ${isPrem && (curPlan === 'class10' || curPlan === 'class10_yearly') ? '✅ Your Current Plan' : '💳 Monthly ₹129/mo'}
        </button>
        <button onclick="handlePayment('class10_yearly')" style="width:100%;padding:12px;margin-top:8px;background:linear-gradient(135deg,#f59e0b,#10b981);border:none;border-radius:11px;color:#fff;font-size:14px;font-weight:800;cursor:pointer;box-shadow:0 4px 18px rgba(245,158,11,0.35);letter-spacing:0.02em;">
          ${isPrem && curPlan === 'class10_yearly' ? '✅ Your Current Plan' : '🌟 Yearly ₹1299 — Save ₹249!'}
        </button>
        <div style="font-size:10.5px;color:rgba(200,195,255,0.45);text-align:center;margin-top:6px;">₹1299/year = only ₹108/month</div>
      </div>

      <!-- ── Plan 4: Battle Creator ₹99/month ── -->
      <div style="background:rgba(245,158,11,0.05);border:1.5px solid rgba(245,158,11,0.35);border-radius:16px;padding:18px;position:relative;">
        <div style="position:absolute;top:-11px;left:16px;background:linear-gradient(135deg,#f59e0b,#ef4444);color:#fff;font-size:10px;font-weight:800;padding:2px 11px;border-radius:20px;letter-spacing:0.05em;">⚔️ BATTLE CREATOR</div>
        <div style="display:flex;align-items:center;gap:12px;margin-bottom:12px;">
          <span style="font-size:28px;">⚔️</span>
          <div style="flex:1;">
            <div style="font-weight:800;font-size:16px;color:#fff;">Battle Creator</div>
            <div style="font-size:11px;color:rgba(200,195,255,0.55);margin-top:1px;">Create online quiz battles · Max 10/month</div>
          </div>
          <div style="text-align:right;">
            <div style="font-size:26px;font-weight:800;color:#f59e0b;line-height:1;">₹99</div>
            <div style="font-size:10px;color:rgba(200,195,255,0.45);">per month</div>
          </div>
        </div>

        <div style="display:grid;grid-template-columns:1fr 1fr;gap:6px;margin-bottom:14px;">
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>⚔️</span> <b>Create 10 battles/month</b></div>
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>👥</span> <b>Up to 10 players/battle</b></div>
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>🤖</span> AI-generated MCQ questions</div>
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>🏆</span> Live XP leaderboard</div>
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>🌐</span> Public battles — all users join</div>
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>📊</span> Real-time score tracking</div>
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>⏱️</span> 3-2-1 countdown launch</div>
          <div style="font-size:11.5px;color:rgba(210,205,255,0.85);display:flex;align-items:center;gap:5px;"><span>🎖️</span> Winner announcement</div>
        </div>

        <div style="background:rgba(245,158,11,0.10);border-radius:9px;padding:9px 12px;margin-bottom:12px;font-size:11.5px;color:rgba(255,220,150,0.85);line-height:1.5;">
          🎯 <b>Be the Battle Admin:</b> Create public quiz battles visible to ALL CrackAI users. Anyone can join free — you lead the competition!
        </div>

        <button onclick="handlePayment('battle')" style="width:100%;padding:13px;background:linear-gradient(135deg,#f59e0b,#ef4444);border:none;border-radius:11px;color:#fff;font-size:14px;font-weight:800;cursor:pointer;box-shadow:0 4px 18px rgba(245,158,11,0.40);letter-spacing:0.02em;">
          ${isPrem && curPlan === 'battle' ? '✅ Your Current Plan' : '⚔️ Become Battle Creator — ₹99/mo'}
        </button>
        <div style="font-size:10.5px;color:rgba(200,195,255,0.45);text-align:center;margin-top:6px;">Free users can always JOIN battles • Only creator needs this plan</div>
      </div>
    ...
    <div style="background:rgba(239,68,68,0.06);border:1px solid rgba(239,68,68,0.18);border-radius:12px;padding:12px 14px;margin-top:12px;">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:4px;font-size:11px;color:rgba(200,195,255,0.50);">
        ...
        <div>❌ Image solving</div><div>❌ PDF solving</div>
        <div>❌ Pro AI models (R1)</div><div>❌ Priority responses</div>
        <div>❌ All class modes (1-12)</div><div>❌ Create quiz battles</div>
      </div>
      <div style="font-size:11px;color:rgba(255,200,150,0.80);margin-top:9px;font-weight:600;text-align:center;">💡 SSC Pro ₹199 · Class Pro ₹129 · Battle Creator ₹99 · Cancel anytime</div>
    </div>
...
function getCosmetics() {
  try { return JSON.parse(localStorage.getItem(COSMETICS_KEY) || '{}'); } catch(e) { return {}; }
}
function saveCosmetics(data) { localStorage.setItem(COSMETICS_KEY, JSON.stringify(data)); }
...
function refreshShopItems() {
  ...
  document.querySelectorAll('.cs-item').forEach(item => {
    ...
    const owned    = (cos['owned_' + type] || []).includes(id);
    const equipped = cos['equipped_' + type] === id;
...
function handleCosmeticsBuy(type, id, cost) {
  const cos   = getCosmetics();
  const owned = cos['owned_' + type] || [];
  const alreadyOwned = owned.includes(id);
  const coins = getCoins();

  if (!alreadyOwned) {
    if (coins < cost) {
      if (typeof showToast === 'function') showToast('🪙 Not enough coins! Need ' + cost + ' coins.');
      return;
    }
    setCoins(coins - cost);
    owned.push(id);
    cos['owned_' + type] = owned;
  }
  // Equip it
  cos['equipped_' + type] = id;
  saveCosmetics(cos);
  applyEquippedCosmetics();
  refreshShopItems();
  if (typeof showToast === 'function') showToast('✅ ' + (alreadyOwned ? 'Equipped' : 'Purchased & equipped') + '!');
}
...
function applyEquippedCosmetics() {
  ...
  const avatarEmojiMap = {
    av_fire:'🔥', av_star:'⭐', av_rocket:'🚀', av_crown:'👑',
    av_ninja:'🥷', av_robot:'🤖', av_dragon:'🐉', av_diamond:'💎'
  };
  const avatarClassMap = {
    av_fire:'av-fire', av_star:'av-star', av_rocket:'av-rocket', av_crown:'av-crown',
  ...
  [document.getElementById('drawerAvatar'), document.getElementById('headerAvatar'), document.getElementById('profileAvatar')].forEach(el => {
    ...
    if (avatar && avatarEmojiMap[avatar]) {
      ...
      const gradMap = {
        'av-fire':'linear-gradient(135deg,#ff4500,#ff8c00)',
        'av-star':'linear-gradient(135deg,#ffd700,#ff8c00)',
        'av-rocket':'linear-gradient(135deg,#6C63FF,#a78bfa)',
        'av-crown':'linear-gradient(135deg,#ffd700,#ffb347)',
        'av-ninja':'linear-gradient(135deg,#1a1a2e,#4a4a6a)',
        'av-robot':'linear-gradient(135deg,#00d4aa,#6C63FF)',
        'av-dragon':'linear-gradient(135deg,#7c3aed,#FF6B9D)',
  ...
  // Apply name color
  const nameColor = cos['equipped_color'];
  const colorMap = {
    nc_purple:'#6C63FF', nc_gold:'linear-gradient(90deg,#ffd700,#ff8c00)',
    nc_red:'#ef4444', nc_cyan:'#22d3ee', nc_green:'#22c55e', nc_pink:'#FF6B9D',
    nc_rainbow:'linear-gradient(90deg,#ff0000,#ff7700,#ffff00,#00ff00,#0000ff,#8b00ff)',
    nc_galaxy:'linear-gradient(90deg,#a78bfa,#f472b6,#fb923c,#a78bfa)'
  };
  [document.getElementById('drawerUserName'), document.getElementById('profileName')].forEach(el => {
    if (!el) return;
    if (nameColor && colorMap[nameColor]) {
      const val = colorMap[nameColor];
      if (val.startsWith('linear')) {
        ...
        el.style.webkitTextFillColor = val;
  ...
  // Apply frame
  const frame = cos['equipped_frame'];
  const frameMap = {
    fr_gold:   '3px solid #ffd700; box-shadow: 0 0 10px rgba(255,215,0,0.5)',
    fr_fire:   '3px solid #ff4500; box-shadow: 0 0 12px rgba(255,69,0,0.6)',
    fr_ice:    '3px solid #00bfff; box-shadow: 0 0 12px rgba(0,191,255,0.5)',
    fr_rainbow:'3px solid #a78bfa; box-shadow: 0 0 12px rgba(167,139,250,0.5)',
    fr_diamond:'3px solid #b9f2ff; box-shadow: 0 0 14px rgba(185,242,255,0.7)',
    fr_neon:   '3px solid #39ff14; box-shadow: 0 0 14px rgba(57,255,20,0.7)'
  };
  [document.getElementById('drawerAvatar'), document.getElementById('headerAvatar'), document.getElementById('profileAvatar')].forEach(el => {
    if (!el) return;
    if (frame && frameMap[frame]) {
      const parts = frameMap[frame].split('; box-shadow: ');
      el.style.border = parts[0];
      el.style.boxShadow = parts[1] || '';
    } else {
